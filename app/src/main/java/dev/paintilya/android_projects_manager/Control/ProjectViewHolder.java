...
public class ProjectViewHolder extends RecyclerView.ViewHolder {
    ...
    public ProjectViewHolder(@NonNull View itemView) {
        super(itemView);
        this.name = itemView.findViewById(R.id.item_project_tv_name);
        this.expenses = itemView.findViewById(R.id.item_project_btn_expenses);
        this.agreements = itemView.findViewById(R.id.item_project_btn_agreements);
