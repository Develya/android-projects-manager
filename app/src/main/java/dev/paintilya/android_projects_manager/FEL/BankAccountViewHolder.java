...
public class BankAccountViewHolder extends RecyclerView.ViewHolder {
    ...
    public BankAccountViewHolder(@NonNull View itemView) {
        ...
        this.name = itemView.findViewById(R.id.bankaccount_tv_name);
        this.balance = itemView.findViewById(R.id.bankaccount_tv_balance);
        this.transaction = itemView.findViewById(R.id.bankaccount_btn_transaction);
